...
(function() {
    ...
    function initSearchSystem() {
        ...
        // Пробуем загрузить products-card.js
        const script = document.createElement('script');
        script.src = '/JS-bt/search/products-card.js';
        script.onload = function() {
            console.log('✅ products-card.js загружен');
        ...
        script.onerror = function() {
            console.error('❌ Не удалось загрузить products-card.js');
            loadFallbackManager();
        };
